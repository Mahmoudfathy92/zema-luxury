...
<body>
  ...
  <header class="site-header">
    <div class="utility-row">
      ...
      <div class="utility-side utility-right">
        <button class="icon-btn" onclick="toggleLanguage()" id="langSwitcherBtn" aria-label="Language" title="Language / تغيير اللغة">
    ...
    <nav class="desktop-nav" aria-label="Main navigation">
      ...
      <a href="#bags-section" id="nav-bags" onclick="showHomePage()">حقائب</a>
  ...
  <script>
    ...
    function toggleLanguage() {
      ...
      if (langBtn) langBtn.setAttribute('title', isAr ? 'Switch to English' : 'التحويل للعربية');
      ...
      const navStory = document.getElementById('nav-our-story');
      if (navStory) navStory.textContent = isAr ? 'قصتنا' : 'Our Story';
      const navHome = document.getElementById('nav-home');
      if (navHome) navHome.textContent = isAr ? 'الرئيسية' : 'Home';
      const navBags = document.getElementById('nav-bags');
      if (navBags) navBags.textContent = isAr ? 'حقائب' : 'Bags';
